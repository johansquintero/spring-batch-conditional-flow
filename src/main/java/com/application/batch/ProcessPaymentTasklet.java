...
public class ProcessPaymentTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution stepContribution, ChunkContext chunkContext) throws Exception {
        ...
        log.info("---->>The payment of the transaction {} is processing successfully",transactionId);

        this.transferPaymentService.updateTransactionalStatus(transactionId,true);
